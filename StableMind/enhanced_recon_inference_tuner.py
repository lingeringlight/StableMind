...
# download_dir = "/ssd/lsm/hub/datasets--pscotti--mindeyev2/snapshots/26421f100e4c6012a35ecadb272a0ec1d999202d"
download_dir = "/data/data/yulin/NSD/"
...
all_images = torch.load(f"{download_dir}/evals/all_images.pt")
all_recons = torch.load(f"{args.ckpt_root}/evals/{args.model_name}/all_recons.pt") # these are the unrefined MindEye2 recons!
...
# base_ckpt_path = '/ssd/lsm/hub/datasets--pscotti--mindeyev2/snapshots/26421f100e4c6012a35ecadb272a0ec1d999202d/zavychromaxl_v30.safetensors'
# base_ckpt_path = '/data1/zyl/NSD/zavychromaxl_v30.safetensors'
base_ckpt_path = '/data/data/yulin/NSD/zavychromaxl_v30.safetensors'
...
base_text_embedder1 = FrozenCLIPEmbedder(
    # version="/ssd/lsm/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41/",
    version="/data/data/gjt/openai-clip-vit-large-patch14/",
...
base_text_embedder2 = FrozenOpenCLIPEmbedder2(
    ...
    cache_dir=conditioner_config['params']['emb_models'][1]['params']['cache_dir'],
)
...
if plotting or num_samples>1:
    clip_img_embedder = FrozenOpenCLIPImageEmbedder(
        ...
        output_tokens=True,
        only_tokens=True,
        cache_dir="/data0/gjt/clip-vit-large-patch14/",
    )
...
torch.save(all_enhancedrecons,f"{args.ckpt_root}/evals/{args.model_name}/all_enhancedrecons.pt")
print(f"saved evals/{args.model_name}/all_enhancedrecons.pt")
